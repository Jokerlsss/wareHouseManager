<template>
  <div class="container">
    ...
    <div class="oprateArea">
      ...
      <div class="searchBtn">
        <el-button class="greenBtn">查找</el-button>
    ...
    >
      ...
      <vxe-table-column field="acount" title="数量" show-overflow type="html"></vxe-table-column>
...
export default {
  ...
  methods: {
    cutBreadTitle () {
      ...
      globalStore.commit('cutPageToInventory')
    },
    resetSearchInput () {
    ...
    mockTableInventoryData () {
      ...
      this.tableInventoryData = Mock.mock({
        ...
        //   productName,productSize，acount
        'list|1-10': [{
